          ...
          <div className="weekly-schedule">
            <div className="calendar">
              ...
              <div className="day-and-activity activity-three">
                <div className="activity">
                  <h2>Add Professor Details</h2>
                </div>
                <div className="bttn">
                  <Link to='/updateprofessor'>
              ...
              <div className="day-and-activity activity-five">
                <div className="activity">
                  <h2>Delete a Club</h2>
                </div>
                <div className="bttn">
